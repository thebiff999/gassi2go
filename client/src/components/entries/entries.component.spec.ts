...
describe('app-entries', () => {
  ...
  it('should navigate to the detail-site', async () => {
    ...
    let button: HTMLElement = element.shadowRoot!.querySelectorAll('button')[4];
    button.click();
  ...
  it('should toggle the view', async () => {
    ...
    let cardView = element.shadowRoot!.querySelector('#entries');
    let mapView = element.shadowRoot!.querySelector('#map-container');
