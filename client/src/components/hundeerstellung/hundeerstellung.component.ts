...
export class HundeerstellungComponent extends PageMixin(LitElement) {
  static styles = [
    css`
      ${unsafeCSS(hundeerstellungComponentSCSS)}
    `
  ];
          ...
          <div class="form-row mx-4 mt-4">
            ...
            <div class="col-lg-4">
              ...
              <div class="pictureinput m-4">
                ...
                <button id="uploadbtn" class="btn btn-sm btn-white d-table mx-auto mt-4" type="button">
                  Foto hochladen
                </button>
      ...
      try {
        ...
        if (response.ok) {
          this.setNotification({
            infoMessage: 'Ihr Hund wurde erfolgreich angelegt. Sie werden zur Hundeübersicht weitergeleitet. '
          });
          window.setTimeout(() => {
            router.navigate('/user/dogs');
          }, 5000);
          return response;
        } else {
