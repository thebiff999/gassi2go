...
import { customElement, LitElement, css, html, unsafeCSS, internalProperty } from 'lit-element';
...
class EntryComponent extends PageMixin(LitElement) {
  static styles = [
    css`
      ${unsafeCSS(assignmentsComponentCSS)}
    `
  ];
              ...
              html`
                <div class="list-item">
                  <div class="desktop shadow">
                    ...
                    <span class="name"> ${assignment.dogName} </span>
                    <span class="date">
                      <p>${assignment.date}</p>
                    </span>
                    <span class="type">
                  ...
                  <div class="row mobile shadow">
                    ...
                    <div class="col-sm-6 details">
                      ...
                      <button @click=${() => this.submit(assignment)} class="btn btn-primary">
                        Erledigt <i class="fas fa-check"></i>
                      </button>
                    </div>
                  </div>
                </div>
  ...
  async submit(assignment: Entry) {
    ...
    try {
      ...
      const notification = 'Auftrag erledigt';
