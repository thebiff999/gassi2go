...
describe('app-auftragserstellung', () => {
    ...
    it('should render a combobox option for each dog', async() =>{
        const hunde = [
            ...
            {besitzerId: '2a2b2c', name: 'Maja', rasse: 'Landseer', gebDate: '2015-07-15', infos: 'Zwar schon ein paar Jahre alt, trotzdem noch sehr verspielt und total tollpatschig.', imgPath: './../../../resources/uploads/d52f472b-7a97-49f1-ab0e-321dd26dac6cbernasenne.jpg'},
            {besitzerId: '3a3b3c', name: 'Rex', rasse: 'Chihuahua', gebDate: '2018-04-20', infos: 'Wie die meisten kleinen Hund, nimmst er sich viel zu ernst und denkt er wäre der Groeßte.', imgPath: './../../../resources/uploads/d52f472b-7a97-49f1-ab0e-321dd26dac6cbernasenne.jpg'}
        ]
