    ...
    const hunde = [
      {
        ...
        infos:
          'Ein treuer Begleiter, der es liebt gefordert zu werden. Aber Vorsicht! Kann ziemlich stark an der Leine ziehen, falls er in der Ferne ein Reh entdeckt. ',
        name: 'Oskar',
      ...
      },
      {
        ...
        imgPath: './../../../resources/uploads/d52f472b-7a97-49f1-ab0e-321dd26dac6cbernasenne.jpg',
        infos:
          'Sie ist eine selbstbewusste und gutmütige Mutter, die sich ihren Platz auf dem Sofa nicht mehr nehmen lässt... ',
        name: 'Maja',
        rasse: 'Bernasenne'
      },
      {
        ...
        infos:
          'Vielleicht der sensibelste Hund, den Sie jemals kennenlernen werden. Einmal bin ich ihm ausversehen auf die Pfote getreten und er war 3 Tage beleidigt. Sonst sehr anhänglich und kinderlieb. ',
        name: 'Rocky',
